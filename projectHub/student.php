...
<body>
 ...
 <li class="ac"><a href="home.php">Home</a></li>
                  <li class="ac"><a href="project.php">Projects</a></li>
                  <li class="ac active"><a href="student.php">Students</a></li>
...
<!-- !PAGE CONTENT! -->
  ...
  <!-- Header -->
   ...
   <div class="w3-container">
      <h4><br><br>Student Data</h4>

       
       <?php
       if($_SESSION['type']=="Admin"){
       echo '<a href="student-add.php" class="w3-button w3-blue w3-right">Add student <span class="w3-text-red">+</span></a>';
        }
        ?>
       ...
       <table>
           ...
           <?php
            ...
            while($row=mysqli_fetch_assoc($result))
            {
               ...
               echo "<td><a href='projectCopy.php?stuId=".$row['Student_id']."' class='w3-button w3-black'> Click Here </a>";
           ...
           $sql2 = "SELECT * FROM tbluser";
            ...
            {
               echo '<tr bgcolor="white">';
               echo '<td>'.$row2['id_roll'].'</td>';
               echo '<td>'.$row2['Firstname'].'</td>';
               echo '<td>'.$row2['Email'].'</td>';
               echo '<td>'.$row2['phn'].'</td>';
               echo '<td>'.$row2['batch'].'</td>';
               echo '<td>'.$row2['supid'].'</td>';
               echo "<td><a href='projectCopy.php?stuId=".$row2['id_roll']."' class='w3-button w3-black'> Click Here </a>";
