...
<!-- !PAGE CONTENT! -->
  ...
  <!-- Header -->
      ...
      <form class="w3-container" action="supinfophp.php" method="post">
        <p><br><br></p>
          
                 <p><label>Supervisor id</label>
                      <input class="w3-input w3-light-grey w3-animate-input" type="number" name="supid"></p>
                 <p>
                     <label>Name</label>
