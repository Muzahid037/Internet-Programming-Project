            ...
            <div class="collapse navbar-collapse navbar-right " id="mynavbar">
              <ul class="nav navbar-nav">
                ...
                <li class="ac"><a href="home.php">Home</a></li>
                  ...
                  <li class="ac active"><a href="supervisor.php">Supervisor</a></li>
...
<!-- !PAGE CONTENT! -->
  ...
  <!-- Header -->
   ...
   <div class="w3-container">
      <h4><br><br>Supervisor Data</h4>
       

      <?php
       if($_SESSION['type']=="Admin"){
       echo '<a href="supervisor-add.php" class="w3-button w3-blue w3-right">Add supervisor <span class="w3-text-red">+</span></a>  <br><br> ';
        }
        ?>

      <!--
       <a href="supervisor-add.php" class="w3-button w3-blue w3-right">Add supervisor <span class="w3-text-red">+</span></a> 
       <br><br>

     -->
       <table>
           <tr><th>Supervisor id</th>
               <th>Name</th>
               <th>Email</th>
               <th>Phone no</th>
             <!--  <th>See details</th>  -->
           ...
           <?php
            ...
            while($row=mysqli_fetch_assoc($result))
            {
              ...
              // echo "<td><a href='#stddetails.php' class='w3-button w3-black'> Click Here </a>";
